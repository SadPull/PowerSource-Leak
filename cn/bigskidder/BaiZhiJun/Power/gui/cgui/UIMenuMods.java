...
public class UIMenuMods {
   ...
   public void draw(int mouseX, int mouseY) {
      ...
      if (this.yPos != (double)(this.y - this.modList.size() * 20)) {
         RenderUtil.drawRoundedRect((float)this.x, Math.min((float)(this.y + MAX_HEIGHT), bottomY) - 2.0F, (float)(this.x + this.width), Math.min((float)(this.y + MAX_HEIGHT), bottomY) + 10.0F, 1.5F, Gui.mode.isCurrentMode("Slowly") ? -14010033 : -8487037);
      }
      ...
      for(Iterator var11 = this.modList.iterator(); var11.hasNext(); yAxis += height) {
         ...
         net.minecraft.client.gui.Gui.drawRect(this.x, yAxis, this.x + this.width, yAxis + height, Gui.mode.isCurrentMode("Slowly") ? -13220000 : -13223618);
         if (m.isEnabled()) {
            net.minecraft.client.gui.Gui.drawRect(this.x, yAxis, this.x + this.width, yAxis + height, Gui.mode.isCurrentMode("Slowly") ? -15425034 : -13613216);
         }
         ...
         if (m.openValues) {
            ...
            net.minecraft.client.gui.Gui.drawRect(this.x, yAxis + height, this.x + this.width, yAxis + height + 1, ClientUtil.reAlpha(Colors.BLACK.c, 0.5F));
