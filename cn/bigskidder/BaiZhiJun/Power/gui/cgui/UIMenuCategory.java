...
public class UIMenuCategory {
   ...
   public void draw(int mouseX, int mouseY) {
      ...
      RenderUtil.drawRoundedRect((float)this.x, (float)this.y, (float)(this.x + this.width), (float)(this.y + this.tab_height), 1.5F, Gui.mode.isCurrentMode("Slowly") ? -14010033 : -8487037);
      String name = "";
      ...
      if (hoverArrow) {
         RenderUtil.drawImage(new ResourceLocation("slowly/icon/arrow-down.png"), this.x + this.width - 10, this.y + 12, 5, 5, new Color(0.7058824F, 0.7058824F, 0.7058824F));
      } else {
         RenderUtil.drawImage(new ResourceLocation("slowly/icon/arrow-down.png"), this.x + this.width - 10, this.y + 12, 5, 5);
      }

      GL11.glPopMatrix();
      if (Gui.mode.isCurrentMode("Slowly")) {
         RenderUtil.drawImage(new ResourceLocation("slowly/icon/menu.png"), this.x + 10, this.y + 10, 8, 8);
      }
