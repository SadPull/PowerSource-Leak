...
public class UIPopUPButton {
   ...
   public void draw(int mouseX, int mouseY) {
      ...
      if (this.openButton.name.equals("Music")) {
         Client.getInstance();
         Client.uiRadio.draw(mouseX, mouseY);
      }
   ...
   public void mouseClicked(int mouseX, int mouseY, int button) {
      ...
      if (this.openButton.name.equals("Music")) {
         Client.getInstance();
         Client.uiRadio.mouseClicked(mouseX, mouseY, button);
      }
   ...
   public void mouseReleased(int mouseX, int mouseY) {
      ...
      if (this.openButton.name.equals("Music")) {
         Client.getInstance();
         Client.uiRadio.mouseReleased(mouseX, mouseY);
      }
